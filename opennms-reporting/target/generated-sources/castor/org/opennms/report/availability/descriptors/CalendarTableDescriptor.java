...
@SuppressWarnings("all") public class CalendarTableDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public CalendarTableDescriptor() {
        ...
        //-- _daysOfWeek
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.opennms.report.availability.DaysOfWeek.class, "_daysOfWeek", "daysOfWeek", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    CalendarTable target = (CalendarTable) object;
                    target.setDaysOfWeek( (org.opennms.report.availability.DaysOfWeek) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.opennms.report.availability.DaysOfWeek();
            }
        };
        desc.setSchemaType("org.opennms.report.availability.DaysOfWeek");
        desc.setHandler(handler);
        ...
        desc.setValidator(fieldValidator);
        //-- _weekList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.opennms.report.availability.Week.class, "_weekList", "week", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    CalendarTable target = (CalendarTable) object;
                    target.addWeek( (org.opennms.report.availability.Week) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.opennms.report.availability.Week();
            }
        };
        desc.setSchemaType("org.opennms.report.availability.Week");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://xmlns.opennms.org/xsd/report/availability");
    ...
    public java.lang.Class<?> getJavaClass(
        ...
        return org.opennms.report.availability.CalendarTable.class;
    }
