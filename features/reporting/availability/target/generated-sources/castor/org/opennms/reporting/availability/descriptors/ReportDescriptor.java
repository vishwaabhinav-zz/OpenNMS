...
@SuppressWarnings("all") public class ReportDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ReportDescriptor() {
        ...
        //-- _created
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.opennms.reporting.availability.Created.class, "_created", "created", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Report target = (Report) object;
                    target.setCreated( (org.opennms.reporting.availability.Created) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.opennms.reporting.availability.Created();
            }
        };
        desc.setSchemaType("org.opennms.reporting.availability.Created");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://xmlns.opennms.org/xsd/report/availability");
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        ...
        desc.setValidator(fieldValidator);
        //-- _viewInfo
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.opennms.reporting.availability.ViewInfo.class, "_viewInfo", "viewInfo", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Report target = (Report) object;
                    target.setViewInfo( (org.opennms.reporting.availability.ViewInfo) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.opennms.reporting.availability.ViewInfo();
            }
        };
        desc.setSchemaType("org.opennms.reporting.availability.ViewInfo");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://xmlns.opennms.org/xsd/report/availability");
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        ...
        desc.setValidator(fieldValidator);
        //-- _categories
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.opennms.reporting.availability.Categories.class, "_categories", "categories", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Report target = (Report) object;
                    target.setCategories( (org.opennms.reporting.availability.Categories) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.opennms.reporting.availability.Categories();
            }
        };
        desc.setSchemaType("org.opennms.reporting.availability.Categories");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://xmlns.opennms.org/xsd/report/availability");
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
    ...
    public java.lang.Class<?> getJavaClass(
        ...
        return org.opennms.reporting.availability.Report.class;
    }
