...
public class OnmsSimplePagerResources_default_StaticClientBundleGenerator implements org.opennms.features.node.list.gwt.client.OnmsSimplePagerResources {
  private static OnmsSimplePagerResources_default_StaticClientBundleGenerator _instance0 = new OnmsSimplePagerResources_default_StaticClientBundleGenerator();
  ...
  private void simplePagerStyleInitializer() {
    simplePagerStyle = new com.google.gwt.user.cellview.client.SimplePager.Style() {
      ...
      public String getText() {
        return (".GALD-WOMF{padding:" + ("4px"+ " " +"8px")  + ";text-align:" + ("center")  + ";}.GALD-WOKF{padding:" + ("4px")  + ";cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GALD-WOLF{cursor:" + ("default")  + ";}.GALD-WOMF{padding:" + ("4px"+ " " +"8px")  + ";text-align:" + ("center")  + ";border:" + ("none")  + ";}.GALD-WOKF{padding:" + ("4px")  + ";cursor:") + (("pointer")  + ";cursor:" + ("hand")  + ";border:" + ("none")  + ";}.GALD-WOLF{cursor:" + ("default")  + ";border:" + ("none")  + ";}");
      }
  ...
  private native ResourcePrototype getResourceNative(String name) /*-{
    switch (name) {
      ...
      case 'simplePagerStyle': return this.@org.opennms.features.node.list.gwt.client.OnmsSimplePagerResources::simplePagerStyle()();
    }
    return null;
  }-*/;
}
