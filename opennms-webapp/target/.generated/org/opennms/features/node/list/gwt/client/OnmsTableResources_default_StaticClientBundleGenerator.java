...
public class OnmsTableResources_default_StaticClientBundleGenerator implements org.opennms.features.node.list.gwt.client.OnmsTableResources {
  private static OnmsTableResources_default_StaticClientBundleGenerator _instance0 = new OnmsTableResources_default_StaticClientBundleGenerator();
  ...
  private void cellTableStyleInitializer() {
    cellTableStyle = new com.google.gwt.user.cellview.client.CellTable.Style() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GALD-WONC{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("0")  + ";}.GALD-WOOC{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("white")  + ";text-shadow:" + ("none")  + ";}.GALD-WOHC{padding:") + (("2px"+ " " +"15px")  + ";background:" + ("inherit")  + ";}.GALD-WOPC{background:" + ("#eee")  + ";}.GALD-WOAD{background-color:" + ("#eee")  + ";}.GALD-WOCD{background:" + ("#ffc")  + ";}.GALD-WODD{border:" + ("1px"+ " " +"solid"+ " " +"#ffc")  + ";}.GALD-WOKD{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GALD-WOLD{border:" + ("1px"+ " " +"solid"+ " " +"#628cd5") ) + (";background-color:" + ("#628cd5")  + ";}.GALD-WOBD{border:" + ("1px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GALD-WOHD{height:" + ((OnmsTableResources_default_StaticClientBundleGenerator.this.cellTableLoading()).getHeight() + "px")  + ";width:" + ((OnmsTableResources_default_StaticClientBundleGenerator.this.cellTableLoading()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (OnmsTableResources_default_StaticClientBundleGenerator.this.cellTableLoading()).getURL() + "\") -" + (OnmsTableResources_default_StaticClientBundleGenerator.this.cellTableLoading()).getLeft() + "px -" + (OnmsTableResources_default_StaticClientBundleGenerator.this.cellTableLoading()).getTop() + "px  no-repeat")  + ";margin:" + ("30px")  + ";}")) : ((".GALD-WONC{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("0")  + ";}.GALD-WOOC{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("white")  + ";text-shadow:" + ("none")  + ";}.GALD-WOHC{padding:") + (("2px"+ " " +"15px")  + ";background:" + ("inherit")  + ";}.GALD-WOPC{background:" + ("#eee")  + ";}.GALD-WOAD{background-color:" + ("#eee")  + ";}.GALD-WOCD{background:" + ("#ffc")  + ";}.GALD-WODD{border:" + ("1px"+ " " +"solid"+ " " +"#ffc")  + ";}.GALD-WOKD{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GALD-WOLD{border:" + ("1px"+ " " +"solid"+ " " +"#628cd5") ) + (";background-color:" + ("#628cd5")  + ";}.GALD-WOBD{border:" + ("1px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GALD-WOHD{height:" + ((OnmsTableResources_default_StaticClientBundleGenerator.this.cellTableLoading()).getHeight() + "px")  + ";width:" + ((OnmsTableResources_default_StaticClientBundleGenerator.this.cellTableLoading()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (OnmsTableResources_default_StaticClientBundleGenerator.this.cellTableLoading()).getURL() + "\") -" + (OnmsTableResources_default_StaticClientBundleGenerator.this.cellTableLoading()).getLeft() + "px -" + (OnmsTableResources_default_StaticClientBundleGenerator.this.cellTableLoading()).getTop() + "px  no-repeat")  + ";margin:" + ("30px")  + ";}"));
      }
  ...
  private native ResourcePrototype getResourceNative(String name) /*-{
    switch (name) {
      ...
      case 'cellTableStyle': return this.@org.opennms.features.node.list.gwt.client.OnmsTableResources::cellTableStyle()();
    }
    return null;
  }-*/;
}
