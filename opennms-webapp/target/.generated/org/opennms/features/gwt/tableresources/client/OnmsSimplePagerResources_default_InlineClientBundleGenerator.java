...
public class OnmsSimplePagerResources_default_InlineClientBundleGenerator implements org.opennms.features.gwt.tableresources.client.OnmsSimplePagerResources {
  ...
  private void simplePagerStyleInitializer() {
    simplePagerStyle = new com.google.gwt.user.cellview.client.SimplePager.Style() {
      ...
      public String getText() {
        return (".GALD-WOMF{padding:" + ("4px"+ " " +"8px")  + ";text-align:" + ("center")  + ";border:" + ("none")  + ";}.GALD-WOKF{padding:" + ("4px")  + ";cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";border:" + ("none")  + ";}.GALD-WOLF{cursor:" + ("default")  + ";border:" + ("none")  + ";}");
      }
  ...
  private native ResourcePrototype getResourceNative(String name) /*-{
    switch (name) {
      ...
      case 'simplePagerStyle': return this.@org.opennms.features.gwt.tableresources.client.OnmsSimplePagerResources::simplePagerStyle()();
    }
    return null;
  }-*/;
}
