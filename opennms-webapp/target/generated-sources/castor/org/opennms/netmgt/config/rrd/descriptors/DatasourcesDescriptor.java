 ...
 */
@SuppressWarnings("all") public class DatasourcesDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public DatasourcesDescriptor() {
        ...
        desc.setSchemaType("org.opennms.netmgt.config.rrd.Def");
        ...
        desc.setSchemaType("org.opennms.netmgt.config.rrd.Export_data");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://xmlns.opennms.org/xsd/rrd");
        desc.setMultivalued(true);
        addFieldDescriptor(desc);
