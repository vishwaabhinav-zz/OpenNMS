...
@SuppressWarnings("all") public class ReadmailConfigDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ReadmailConfigDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _readmailHost
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.opennms.netmgt.config.javamail.ReadmailHost.class, "_readmailHost", "readmail-host", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ReadmailConfig target = (ReadmailConfig) object;
                    target.setReadmailHost( (org.opennms.netmgt.config.javamail.ReadmailHost) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.opennms.netmgt.config.javamail.ReadmailHost();
            }
        };
        desc.setSchemaType("org.opennms.netmgt.config.javamail.ReadmailHost");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://xmlns.opennms.org/xsd/config/javamail-configuration");
        desc.setRequired(true);
        desc.setMultivalued(false);
    ...
    public java.lang.Class<?> getJavaClass(
        ...
        return org.opennms.netmgt.config.javamail.ReadmailConfig.class;
    }
