...
@SuppressWarnings("all") public class Views implements java.io.Serializable {
     ...
     * Field _viewList.
     */
    private java.util.List<org.opennms.netmgt.config.views.View> _viewList;
    ...
    public Views() {
        super();
        this._viewList = new java.util.ArrayList<org.opennms.netmgt.config.views.View>();
    }
     ...
     */
    public void addView(
            final org.opennms.netmgt.config.views.View vView)
     ...
     * collection
     */
    public java.util.Enumeration<org.opennms.netmgt.config.views.View> enumerateView(
    ) {
     ...
     * org.opennms.netmgt.config.views.View at the given index
     */
    public org.opennms.netmgt.config.views.View getView(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.opennms.netmgt.config.views.View) _viewList.get(index);
    }
    ...
    public org.opennms.netmgt.config.views.View[] getView(
        ...
        org.opennms.netmgt.config.views.View[] array = new org.opennms.netmgt.config.views.View[0];
        return (org.opennms.netmgt.config.views.View[]) this._viewList.toArray(array);
    }
     ...
     */
    public java.util.List<org.opennms.netmgt.config.views.View> getViewCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<org.opennms.netmgt.config.views.View> iterateView(
    ) {
     ...
     */
    public org.opennms.netmgt.config.views.View removeViewAt(
            final int index) {
        java.lang.Object obj = this._viewList.remove(index);
        return (org.opennms.netmgt.config.views.View) obj;
    }
     ...
     */
    public void setView(
            final org.opennms.netmgt.config.views.View[] vViewArray) {
        //-- copy array
        _viewList.clear();
     ...
     */
    public void setView(
            final java.util.List<org.opennms.netmgt.config.views.View> vViewList) {
        // copy vector
        this._viewList.clear();
    ...
    public void setViewCollection(
            final java.util.List<org.opennms.netmgt.config.views.View> viewList) {
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled org.opennms.netmgt.config.views.Views
     */
    public static org.opennms.netmgt.config.views.Views unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.opennms.netmgt.config.views.Views) Unmarshaller.unmarshal(org.opennms.netmgt.config.views.Views.class, reader);
    }
