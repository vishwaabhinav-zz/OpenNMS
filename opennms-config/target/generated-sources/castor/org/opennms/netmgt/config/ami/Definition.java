...
@SuppressWarnings("all") public class Definition implements java.io.Serializable {
     ...
     *  
     */
    private java.util.List<org.opennms.netmgt.config.ami.Range> _rangeList;
    ...
    public Definition() {
        super();
        this._rangeList = new java.util.ArrayList<org.opennms.netmgt.config.ami.Range>();
    ...
    public void addRange(
            final org.opennms.netmgt.config.ami.Range vRange)
    throws java.lang.IndexOutOfBoundsException {
     ...
     * collection
     */
    public java.util.Enumeration<org.opennms.netmgt.config.ami.Range> enumerateRange(
    ) {
     ...
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     * @return the value of the org.opennms.netmgt.config.ami.Range
     * at the given index
     */
    public org.opennms.netmgt.config.ami.Range getRange(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        ...
        return (org.opennms.netmgt.config.ami.Range) _rangeList.get(index);
    }
    ...
    public org.opennms.netmgt.config.ami.Range[] getRange(
        ...
        org.opennms.netmgt.config.ami.Range[] array = new org.opennms.netmgt.config.ami.Range[0];
        return (org.opennms.netmgt.config.ami.Range[]) this._rangeList.toArray(array);
    }
     ...
     * @return a reference to the Vector backing this class
     */
    public java.util.List<org.opennms.netmgt.config.ami.Range> getRangeCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<org.opennms.netmgt.config.ami.Range> iterateRange(
    ) {
     ...
     * @return the element removed from the collection
     */
    public org.opennms.netmgt.config.ami.Range removeRangeAt(
            final int index) {
        java.lang.Object obj = this._rangeList.remove(index);
        return (org.opennms.netmgt.config.ami.Range) obj;
    }
     ...
     */
    public void setRange(
            final org.opennms.netmgt.config.ami.Range[] vRangeArray) {
        //-- copy array
        _rangeList.clear();
     ...
     */
    public void setRange(
            final java.util.List<org.opennms.netmgt.config.ami.Range> vRangeList) {
        // copy vector
        this._rangeList.clear();
    ...
    public void setRangeCollection(
            final java.util.List<org.opennms.netmgt.config.ami.Range> rangeList) {
     ...
     */
    public static org.opennms.netmgt.config.ami.Definition unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.opennms.netmgt.config.ami.Definition) Unmarshaller.unmarshal(org.opennms.netmgt.config.ami.Definition.class, reader);
    }
