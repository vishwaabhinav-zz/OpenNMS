...
@SuppressWarnings("all") public class Categories implements java.io.Serializable {
     ...
     * Field _categoryList.
     */
    private java.util.List<org.opennms.netmgt.config.views.Category> _categoryList;
    ...
    public Categories() {
        super();
        this._categoryList = new java.util.ArrayList<org.opennms.netmgt.config.views.Category>();
    }
    ...
    public void addCategory(
            final org.opennms.netmgt.config.views.Category vCategory)
     ...
     * collection
     */
    public java.util.Enumeration<org.opennms.netmgt.config.views.Category> enumerateCategory(
    ) {
     ...
     * org.opennms.netmgt.config.views.Category at the given index
     */
    public org.opennms.netmgt.config.views.Category getCategory(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.opennms.netmgt.config.views.Category) _categoryList.get(index);
    }
    ...
    public org.opennms.netmgt.config.views.Category[] getCategory(
        ...
        org.opennms.netmgt.config.views.Category[] array = new org.opennms.netmgt.config.views.Category[0];
        return (org.opennms.netmgt.config.views.Category[]) this._categoryList.toArray(array);
    }
     ...
     */
    public java.util.List<org.opennms.netmgt.config.views.Category> getCategoryCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<org.opennms.netmgt.config.views.Category> iterateCategory(
    ) {
     ...
     */
    public org.opennms.netmgt.config.views.Category removeCategoryAt(
            final int index) {
        java.lang.Object obj = this._categoryList.remove(index);
        return (org.opennms.netmgt.config.views.Category) obj;
    }
     ...
     */
    public void setCategory(
            final org.opennms.netmgt.config.views.Category[] vCategoryArray) {
        //-- copy array
        _categoryList.clear();
     ...
     */
    public void setCategory(
            final java.util.List<org.opennms.netmgt.config.views.Category> vCategoryList) {
        // copy vector
        this._categoryList.clear();
    ...
    public void setCategoryCollection(
            final java.util.List<org.opennms.netmgt.config.views.Category> categoryList) {
     ...
     * org.opennms.netmgt.config.views.Categories
     */
    public static org.opennms.netmgt.config.views.Categories unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.opennms.netmgt.config.views.Categories) Unmarshaller.unmarshal(org.opennms.netmgt.config.views.Categories.class, reader);
    }
