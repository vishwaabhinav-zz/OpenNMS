 ...
 */
@SuppressWarnings("all") public class ExcludesDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ExcludesDescriptor() {
        ...
        //-- _rangeList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.opennms.netmgt.config.vulnscand.Range.class, "_rangeList", "range", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Excludes target = (Excludes) object;
                    target.addRange( (org.opennms.netmgt.config.vulnscand.Range) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.opennms.netmgt.config.vulnscand.Range();
            }
        };
        desc.setSchemaType("org.opennms.netmgt.config.vulnscand.Range");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://xmlns.opennms.org/xsd/config/vulnscand");
        desc.setMultivalued(true);
        addFieldDescriptor(desc);
    ...
    public java.lang.Class<?> getJavaClass(
        ...
        return org.opennms.netmgt.config.vulnscand.Excludes.class;
    }
