...
@SuppressWarnings("all") public class ExcludeRange implements java.io.Serializable {
     ...
     * org.opennms.netmgt.config.map.adapter.ExcludeRange
     */
    public static org.opennms.netmgt.config.map.adapter.ExcludeRange unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.opennms.netmgt.config.map.adapter.ExcludeRange) Unmarshaller.unmarshal(org.opennms.netmgt.config.map.adapter.ExcludeRange.class, reader);
    }
