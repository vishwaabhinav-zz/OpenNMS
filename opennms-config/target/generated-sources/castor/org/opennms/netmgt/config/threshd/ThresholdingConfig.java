...
@SuppressWarnings("all") public class ThresholdingConfig implements java.io.Serializable {
     ...
     */
    private java.util.List<org.opennms.netmgt.config.threshd.Group> _groupList;
    ...
    public ThresholdingConfig() {
        super();
        this._groupList = new java.util.ArrayList<org.opennms.netmgt.config.threshd.Group>();
    }
    ...
    public void addGroup(
            final org.opennms.netmgt.config.threshd.Group vGroup)
     ...
     * collection
     */
    public java.util.Enumeration<org.opennms.netmgt.config.threshd.Group> enumerateGroup(
    ) {
     ...
     * org.opennms.netmgt.config.threshd.Group at the given index
     */
    public org.opennms.netmgt.config.threshd.Group getGroup(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.opennms.netmgt.config.threshd.Group) _groupList.get(index);
    }
    ...
    public org.opennms.netmgt.config.threshd.Group[] getGroup(
        ...
        org.opennms.netmgt.config.threshd.Group[] array = new org.opennms.netmgt.config.threshd.Group[0];
        return (org.opennms.netmgt.config.threshd.Group[]) this._groupList.toArray(array);
    }
     ...
     */
    public java.util.List<org.opennms.netmgt.config.threshd.Group> getGroupCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<org.opennms.netmgt.config.threshd.Group> iterateGroup(
    ) {
     ...
     */
    public org.opennms.netmgt.config.threshd.Group removeGroupAt(
            final int index) {
        java.lang.Object obj = this._groupList.remove(index);
        return (org.opennms.netmgt.config.threshd.Group) obj;
    }
     ...
     */
    public void setGroup(
            final org.opennms.netmgt.config.threshd.Group[] vGroupArray) {
        //-- copy array
        _groupList.clear();
     ...
     */
    public void setGroup(
            final java.util.List<org.opennms.netmgt.config.threshd.Group> vGroupList) {
        // copy vector
        this._groupList.clear();
    ...
    public void setGroupCollection(
            final java.util.List<org.opennms.netmgt.config.threshd.Group> groupList) {
     ...
     */
    public static org.opennms.netmgt.config.threshd.ThresholdingConfig unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.opennms.netmgt.config.threshd.ThresholdingConfig) Unmarshaller.unmarshal(org.opennms.netmgt.config.threshd.ThresholdingConfig.class, reader);
    }
